...
<body>
	...
	<div class="iknow_tm_all_wrap" data-magic-cursor="show" data-animation-in="zoomIn" data-animation-out="zoomOut">
		...
		<div class="iknow_tm_modalbox">
			<div class="box_inner">
				<div class="close">
					<a href="#"><img class="svg" src="assets/assets/img/svg/cancel.svg" alt="" /></a>
				</div>
		...
		<div class="iknow_tm_extra_demo">
			...
			<div class="background_part">
				<!-- Hero Shapes -->
				<div class="rounded_shapes">
					<span class="one anim_circle"><img class="svg" src="assets/img/svg/shapes/11.svg" alt="" /></span>
					<span class="two anim_scale2"><img class="svg" src="assets/img/svg/shapes/10.svg" alt="" /></span>
					<span class="three anim_scale2"><img class="svg" src="assets/img/svg/shapes/6.svg" alt="" /></span>
					<span class="four anim_scale2"><img class="svg" src="assets/img/svg/shapes/6.svg" alt="" /></span>
					<span class="five anim_circle"><img class="svg" src="assets/img/svg/shapes/11.svg" alt="" /></span>
					<span class="six anim_scale2"><img class="svg" src="assets/img/svg/shapes/10.svg" alt="" /></span>
					<span class="seven anim_scale2"><img class="svg" src="assets/img/svg/shapes/6.svg" alt="" /></span>
					<span class="eight anim_scale2"><img class="svg" src="assets/img/svg/shapes/10.svg" alt="" /></span>
					<span class="nine anim_scale2"><img class="svg" src="assets/img/svg/shapes/6.svg" alt="" /></span>
					<span class="ten anim_scale2"><img class="svg" src="assets/img/svg/shapes/10.svg" alt="" /></span>
					<span class="eleven anim_circle"><img class="svg" src="assets/img/svg/shapes/11.svg" alt="" /></span>
					<span class="twelve anim_circle"><img class="svg" src="assets/img/svg/shapes/11.svg" alt="" /></span>
					<span class="thirteen anim_scale2"><img class="svg" src="assets/img/svg/shapes/6.svg" alt="" /></span>
					<span class="fourteen anim_circle"><img class="svg" src="assets/img/svg/shapes/11.svg" alt="" /></span>
					<span class="fifteen anim_scale2"><img class="svg" src="assets/img/svg/shapes/6.svg" alt="" /></span>
					<span class="sixteen anim_scale2"><img class="svg" src="assets/img/svg/shapes/10.svg" alt="" /></span>
					<span class="seventeen anim_scale2"><img class="svg" src="assets/img/svg/shapes/10.svg" alt="" /></span>
					<span class="eighteen anim_scale2"><img class="svg" src="assets/img/svg/shapes/10.svg" alt="" /></span>
				</div>
				<!-- /Hero Shapes -->
			</div>
			...
			<!-- TOPBAR -->
			<div class="iknow_tm_topbar onepage">
				<div class="topbar_inner">
					...
					<div class="right">
						<div class="social">
							<ul>
								<li><a href="#"><img class="svg" src="assets/img/svg/social/facebook-2.svg" alt="" /></a></li>
								<li><a href="#"><img class="svg" src="assets/img/svg/social/twitter-2.svg" alt="" /></a></li>
								<li><a href="#"><img class="svg" src="assets/img/svg/social/youtube-3.svg" alt="" /></a></li>
								<li><a href="#"><img class="svg" src="assets/img/svg/social/instagram-2.svg" alt="" /></a></li>
							</ul>
						</div>
					</div>
				</div>
			...
			<!-- SIDEBAR -->
			<div class="iknow_tm_sidebar_3">
				<div class="inner">
					<div class="image">
						<div class="main" data-img-url="assets/img/about/3.jpg"></div>
					</div>
					<div class="menu scrollable">
						<ul class="anchor_nav">
							<li class="current">
								<img class="svg" src="assets/img/svg/squares.svg" alt="" />
								<span>Home</span>
								<a class="iknow_tm_full_link" href="#home"></a>
							</li>
							<li>
								<img class="svg" src="assets/img/svg/archive.svg" alt="" />
								<span>About Me</span>
								<a class="iknow_tm_full_link" href="#about"></a>
							</li>
							<li>
								<img class="svg" src="assets/img/svg/contacs.svg" alt="" />
								<span>Resume</span>
								<a class="iknow_tm_full_link" href="#resume"></a>
							</li>
							<li>
								<img class="svg" src="assets/img/svg/briefcase.svg" alt="" />
								<span>Portfolio</span>
...
-->
			...
			<div class="iknow_tm_content_wrapper">
				<!-- HERO -->
				<div class="iknow_tm_hero_third" id="home">
					<div class="background">
						<div class="image" data-img-url="assets/img/hero/8.jpg"></div>
					...
					<div class="iknow_tm_about">
						<div class="left">
							<div class="left_inner">
								<div class="image">
									<img src="assets/img/thumbs/35-44.jpg" alt="" />
									<div class="main" data-img-url="assets/img/about/3.jpg"></div>
								</div>
								<div class="details">
									<ul>
										...
										<li>
											<h3>Mail</h3>
											<span><a href="https://marketifythemes.net/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="82eae7eeeeedc2e8e3efe7f1ace1edef">[email&#160;protected]</a></span>
										</li>
										<li>
											<h3>Phone</h3>
						...
						<div class="right">
							...
							<div class="text">
								<p>Hi! My name is James Smith. I am UI/UX designer, and I'm very passionate and dedicated to my work. With 20 years experience as a professional graphic designer, I have acquired the skills and knowledge necessary to make your project a success.</p>
							</div>
							<div class="iknow_tm_button">
								<a href="assets/img/cv/1.jpg" download>Download CV</a>
							</div>
							...
							<ul class="gallery_zoom">
								...
								<li class="youtube">
									<div class="list_inner">
										...
										<div class="overlay"></div>
										<img class="svg" src="assets/img/svg/social/youtube-2.svg" alt="" />
										<div class="details">
											<span>Youtube</span>
											<h3>Bicker &amp; Jenna</h3>
										</div>
								...
								<li class="soundcloud">
									<div class="list_inner">
										...
										<div class="overlay"></div>
										<img class="svg" src="assets/img/svg/social/soundcloud.svg" alt="" />
										<div class="details">
								...
								<li class="detail">
									<div class="list_inner">
										...
										<div class="overlay"></div>
										<img class="svg" src="assets/img/svg/text.svg" alt="" />
										<div class="details">
											<span>Detail</span>
											<h3>Teresa Melbig</h3>
										</div>
					...
					<div class="iknow_tm_services">
						...
						<div class="service_list">
							<ul>
								<li>
									<div class="list_inner">
										<span class="icon"><img class="svg" src="assets/img/svg/squares.svg" alt="" /></span>
										...
										<div class="hidden_content">
											<div class="service_informations">
												<div class="image">
													<img src="assets/img/thumbs/4-2.jpg" alt="" />
													<div class="main" data-img-url="assets/img/service/1.jpg"></div>
												</div>
								...
								<li>
									<div class="list_inner">
										<span class="icon"><img class="svg" src="assets/img/svg/physics.svg" alt="" /></span>
										...
										<div class="hidden_content">
											<div class="service_informations">
												<div class="image">
													<img src="assets/img/thumbs/4-2.jpg" alt="" />
													<div class="main" data-img-url="assets/img/service/2.jpg"></div>
												</div>
												<div class="description">
													<p>iKnow is a leading web design agency with an award-winning design team that creates innovative, effective websites that capture your brand, improve your conversion rates, and maximize your revenue to help grow your business and achieve your goals.</p>
													<p>In today’s digital world, your website is the first interaction consumers have with your business. That's why almost 95 percent of a user’s first impression relates to web design. It’s also why web design services can have an immense impact on your company’s bottom line.</p>
								...
								<li>
									<div class="list_inner">
										<span class="icon"><img class="svg" src="assets/img/svg/web.svg" alt="" /></span>
										...
										<div class="hidden_content">
											<div class="service_informations">
												<div class="image">
													<img src="assets/img/thumbs/4-2.jpg" alt="" />
													<div class="main" data-img-url="assets/img/service/3.jpg"></div>
												</div>
												<div class="description">
													<p>iKnow is a leading web design agency with an award-winning design team that creates innovative, effective websites that capture your brand, improve your conversion rates, and maximize your revenue to help grow your business and achieve your goals.</p>
													<p>In today’s digital world, your website is the first interaction consumers have with your business. That's why almost 95 percent of a user’s first impression relates to web design. It’s also why web design services can have an immense impact on your company’s bottom line.</p>
								...
								<li>
									<div class="list_inner">
										<span class="icon"><img class="svg" src="assets/img/svg/user.svg" alt="" /></span>
										...
										<div class="hidden_content">
											<div class="service_informations">
												<div class="image">
													<img src="assets/img/thumbs/4-2.jpg" alt="" />
													<div class="main" data-img-url="assets/img/service/4.jpg"></div>
												</div>
												<div class="description">
													<p>iKnow is a leading web design agency with an award-winning design team that creates innovative, effective websites that capture your brand, improve your conversion rates, and maximize your revenue to help grow your business and achieve your goals.</p>
													<p>In today’s digital world, your website is the first interaction consumers have with your business. That's why almost 95 percent of a user’s first impression relates to web design. It’s also why web design services can have an immense impact on your company’s bottom line.</p>
								...
								<li>
									<div class="list_inner">
										<span class="icon"><img class="svg" src="assets/img/svg/briefcase.svg" alt="" /></span>
										...
										<div class="hidden_content">
											<div class="service_informations">
												<div class="image">
													<img src="assets/img/thumbs/4-2.jpg" alt="" />
													<div class="main" data-img-url="assets/img/service/5.jpg"></div>
												</div>
												<div class="description">
													<p>iKnow is a leading web design agency with an award-winning design team that creates innovative, effective websites that capture your brand, improve your conversion rates, and maximize your revenue to help grow your business and achieve your goals.</p>
													<p>In today’s digital world, your website is the first interaction consumers have with your business. That's why almost 95 percent of a user’s first impression relates to web design. It’s also why web design services can have an immense impact on your company’s bottom line.</p>
								...
								<li>
									<div class="list_inner">
										<span class="icon"><img class="svg" src="assets/img/svg/writing_2.svg" alt="" /></span>
										...
										<div class="hidden_content">
											<div class="service_informations">
												<div class="image">
													<img src="assets/img/thumbs/4-2.jpg" alt="" />
													<div class="main" data-img-url="assets/img/service/6.jpg"></div>
												</div>
												<div class="description">
													<p>iKnow is a leading web design agency with an award-winning design team that creates innovative, effective websites that capture your brand, improve your conversion rates, and maximize your revenue to help grow your business and achieve your goals.</p>
													<p>In today’s digital world, your website is the first interaction consumers have with your business. That's why almost 95 percent of a user’s first impression relates to web design. It’s also why web design services can have an immense impact on your company’s bottom line.</p>
				...
				<!-- TESTIMONIALS -->
				<div class="iknow_tm_section_new" id="testimonial">
							...
							<div class="list_inner">
								<div class="in">
									...
									<div class="details">
										...
										<div class="right">
											<img class="svg" src="assets/img/svg/left-quote.svg" alt="" />
										</div>
									</div>
								</div>
							</div>
							...
							<div class="list_inner">
								<div class="in">
									...
									<div class="details">
										<div class="left">
											<div class="avatar">
												<div class="main" data-img-url="assets/img/testimonials/4.jpg"></div>
											</div>
											<div class="info">
							...
							<div class="list_inner">
								<div class="in">
									...
									<div class="details">
										<div class="left">
											<div class="avatar">
												<div class="main" data-img-url="assets/img/testimonials/5.jpg"></div>
											</div>
											<div class="info">
												<h3>Aura Brooklyn</h3>
						...
						<div class="news_list">
							<ul>
								<li>
									<div class="list_inner">
										<div class="image">
											<img src="assets/img/thumbs/37-27.jpg" alt="" />
								...
								<li>
									<div class="list_inner">
										<div class="image">
											<img src="assets/img/thumbs/37-27.jpg" alt="" />
											<div class="main" data-img-url="assets/img/news/2.jpg"></div>
											<a class="iknow_tm_full_link" href="#"></a>
										</div>
										<div class="details">
								...
								<li>
									<div class="list_inner">
										<div class="image">
											<img src="assets/img/thumbs/37-27.jpg" alt="" />
											<div class="main" data-img-url="assets/img/news/3.jpg"></div>
											<a class="iknow_tm_full_link" href="#"></a>
										</div>
										<div class="details">
				...
				<!-- CONTACT -->
				<div class="iknow_tm_section_new contact" id="contact">
						...
						<div class="wrapper">
							<div class="left">
								<ul>
									<li>
										<div class="list_inner">
											<span class="icon"><img class="svg" src="assets/img/svg/smartphone.svg" alt="" /></span>
											<div class="short">
												<h3>Call Me</h3>
												<span>+123 456 7890</span>
											</div>
									...
									<li>
										<div class="list_inner">
											<span class="icon"><img class="svg" src="assets/img/svg/letter.svg" alt="" /></span>
											<div class="short">
												<h3>Email Us</h3>
												<span><a href="#"><span class="__cf_email__" data-cfemail="f199949d9d9eb1989a9f9e86df929e9c">[email&#160;protected]</span></a></span>
											</div>
										</div>
									</li>
									<li>
										<div class="list_inner">
											<span class="icon"><img class="svg" src="assets/img/svg/placeholder.svg" alt="" /></span>
											<div class="short">
												<h3>Address</h3>
